...
public interface KucoinUAPaginatedResponse extends KucoinResponse, PaginatedRestResponse {

  KucoinUAPaginatedResponseData getData();
  ...
  default boolean hasNextPage() {
    KucoinUAPaginatedResponseData data = getData();
    return data != null && data.getPageNumber() < data.getTotalPage();
  }
}
