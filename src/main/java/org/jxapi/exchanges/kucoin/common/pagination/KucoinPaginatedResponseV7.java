 ...
 */
public interface KucoinPaginatedResponseV7 extends KucoinResponse, PaginatedRestResponse {

  KucoinPaginatedResponseV7Page getData();
  ...
  default boolean hasNextPage() {
    return getData() != null && !CollectionUtil.isEmpty(getData().getItems());
  }
}
