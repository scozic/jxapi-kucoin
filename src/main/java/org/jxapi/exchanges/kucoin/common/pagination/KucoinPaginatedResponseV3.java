...
/**
 * Interface for Kucoin paginated responses using 'V3' pagination style using 'hasMore' response property and offset on items (see
 * {@link KucoinPaginatedRequestV3}).
 * <p>
 * Responses of such endpoints contain a page of items that implement
 * {@link KucoinPaginatedResponseV3Item}.
 */
public interface KucoinPaginatedResponseV3 extends KucoinResponse, PaginatedRestResponse {
   ...
   */
  KucoinPaginatedResponseV3Page getData();
}
